...
async def consulta(customer_id, exclude_items: List[int] = []):
    ...
    # diversity scores para cada uno
    diversity_scores = np.sum(item_similarity, axis=0)

    # se los agrega a dataframe
    ...
    # Seleccione al azar 3 recomendaciones por novedad y diversidad
    ...
    #return final_recommendations.to_json(orient='records')
