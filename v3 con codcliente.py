...
async def consulta(customer_id):
    if matrix is None:
        return "Primero prepara el modelo usando '/prepararModelo'"
    ...
    # Extract the recommended items (CodArticu) from the DataFrame
    #recommended_items = user_recommendations['CodArticu'].tolist()
